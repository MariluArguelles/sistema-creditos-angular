...
@Component({
  selector: 'app-botton-pdf-standar',
  standalone: true,
  imports: [CommonModule, IconsModule, MatButtonModule, MatTooltipModule],
  templateUrl: './botton-pdf-standar.component.html',
  styleUrls: ['./botton-pdf-standar.component.scss']
})

  export class BottonPDFStandarComponent implements OnInit {
